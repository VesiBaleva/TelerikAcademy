...
namespace _04.RiskWinsRiskLoses
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string[] forbiddens = new string[forbiddenCombinationscount];
          ...
          // {
          //     int diffsAbs=Math.Abs(int.Parse(startCombination[i].ToString())
          //         - int.Parse(endCombination[i].ToString()));
          //     countCombinations += Math.Min(diffsAbs,10-diffsAbs);
          // }
