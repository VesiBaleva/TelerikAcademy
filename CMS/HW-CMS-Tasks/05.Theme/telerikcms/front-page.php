<?php get_header(); ?>
				...
				<p>
					This simple, fixed width website template is released under a <a
						...
						Attribution 3.0 Licence</a>. This means you are free to download
				...
				<p>
					...
					The photos shown in this template were taken by me. You can view
					more free CSS3 web templates <a
				...
				<p>
					...
					contact form on the contact page. All of the photos were taken by
					me - use as you wish.
				</p>
<?php get_footer();?>