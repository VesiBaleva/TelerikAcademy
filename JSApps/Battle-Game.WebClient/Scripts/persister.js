...
var persisters = (function () {
	...
	var BattlePersister = Class.create({
		...
		move: function (battle, success, error) {
            
		    var positionXY = {
                posX:battle.position
		    }
            var gameData = {
            ...
            var url = this.rootUrl + battle.gameId + "/move/" + sessionKey;
		    httpRequester.postJSON(url, gameData, success, error);
		},
		attack: function (battle,success, error) {
		    var positionXY = {
		        posX: battle.position
		    }
		    var gameData = {
		    ...
		    var url = this.rootUrl + battle.gameId + "/attack/" + sessionKey;
		    httpRequester.postJSON(url, gameData, success, error);
		},
		defend: function (battle, success, error) {
		    
		    var gameData = battle.unitId;

		    var url = this.rootUrl + battle.gameId + "/defend/" + sessionKey;
		    httpRequester.postJSON(url, gameData, success, error);
		}
